...
- `1.png`: promoted into `public/campaign/kcg-brand-gold-bars-20260427-v4.png` for this review round because it has stronger campaign energy than the plain consultation-room image and uses KCG-specific generated branding rather than competitor material.
