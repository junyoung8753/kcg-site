...
- 배포된 것: `v0.2.29`가 기존 personal Hobby Vercel project `kcg-confirm-preview`로 production deployed 됐다. Current production deployment id: `dpl_Fuik6ANNi8sW6q2NTkJ7Y8kRYXvf`. 이 deploy는 noindex-protected review publication이며 search launch가 아니다.
