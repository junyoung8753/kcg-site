...
- 배포된 것: 이번 `v0.2.29`는 기존 개인 Vercel Hobby project `kcg-confirm-preview`로 production deploy 됐다. 배포 id는 `dpl_Fuik6ANNi8sW6q2NTkJ7Y8kRYXvf`이고, 무료 review deploy이며 검색 공개가 아니다.
