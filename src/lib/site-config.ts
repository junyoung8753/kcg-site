...
export const visitChecklist = [
  ...
  "법인 보유분, 상속 정리, 대리 방문은 방문 전 필요 서류를 전화로 먼저 확인해 주세요.",
] as const;
...
export const serviceFaqs = [
  {
    question: "홈페이지 가격과 실제 상담가는 왜 다를 수 있나요?",
    answer:
      "홈페이지는 회사 고시 시세와 기준 시각을 보여줍니다. 실제 안내 금액은 실물의 순도, 중량, 부속, 제품 상태, 수량을 현장에서 확인한 뒤 달라질 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "사진으로는 품목과 준비 사항을 대략 확인할 수 있지만, 최종 금액은 실물의 함량과 중량을 현장에서 확인한 뒤 안내합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "필수 예약제로 안내하지는 않지만, 품목이 많거나 고중량·법인·대량 건이면 방문 전 전화로 시간을 맞추시는 것을 권장합니다.",
  },
  {
    question: "처음 연락할 때 무엇부터 말하면 되나요?",
    answer:
      "품목 종류, 대략 중량·수량, 방문 가능 시간, 법인·대리·상속 정리 여부만 먼저 알려주시면 준비 항목을 더 빠르게 안내할 수 있습니다.",
  },
  {
    question: "신분증이나 준비물이 필요한가요?",
    answer:
      "실물 매입 상담 시 신분증을 지참해 주세요. 보증서, 영수증, 감정서가 있으면 함께 가져오시는 것을 권장드립니다.",
  },
  {
    question: "보증서나 영수증이 없으면 진행이 어렵나요?",
    answer:
      "자료가 없더라도 실물 확인은 가능하지만, 보유 자료가 있으면 품목 확인이 더 수월합니다. 최종 금액은 현장 확인 뒤 안내합니다.",
  },
  {
  ...
  {
    question: "자동 참고시세와 회사 게시 시세는 무엇이 다른가요?",
    answer:
      "자동 참고시세는 시장 흐름 확인용 보조 데이터입니다. KCG 고객 안내 기준은 회사가 고시한 시세이며, 실제 거래 금액은 현장 확인 후 안내합니다.",
  },
] as const;
