...
export const mockAnnouncements: Announcement[] = [
  {
    id: "announcement-1",
    title: "당일 시세 고시 및 방문 상담 운영 안내",
    slug: "daily-price-notice-and-visit-guidance",
    summary:
      "평일 오전 9시부터 오후 6시 30분까지 운영하며, 당일 고시 시세 기준으로 방문 상담을 안내드립니다.",
    content: [
      "한국센터금거래소는 평일 오전 9시부터 오후 6시 30분까지 방문 상담을 운영합니다.",
      "당일 시세는 고시 시각 기준으로 안내되며, 시세 변동이 큰 날에는 전화 문의 후 방문하시면 보다 정확한 안내가 가능합니다.",
  ...
  },
  {
    ...
    summary:
      "방문 전 대표번호로 문의하시면 당일 상담 가능 시간과 준비 사항을 먼저 안내해 드립니다.",
    content: [
      "평일 운영시간은 오전 9시부터 오후 6시 30분까지입니다.",
      "상담 품목, 예상 중량, 방문 목적을 먼저 알려주시면 시세 기준과 준비 사항을 보다 빠르게 안내받으실 수 있습니다.",
      "건물 방문 동선과 주차 가능 여부는 시점에 따라 달라질 수 있어 방문 전 대표번호 문의를 권장드립니다.",
    ].join("\n\n"),
    isPinned: false,
    status: "published",
  ...
  },
  {
    ...
    summary:
      "실물 매입 거래 시 관련 절차에 따라 본인 확인이 필요합니다. 방문 전 신분증을 준비해 주세요.",
    content: [
      "귀금속 및 금제품 매입 상담 시에는 본인 명의 신분증 확인 절차가 진행됩니다.",
      "대리 거래, 법인 거래, 고중량 거래의 경우 추가 확인 서류가 필요할 수 있으니 방문 전 문의를 권장드립니다.",
